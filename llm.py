    ...
    try:
        completion = client.chat.completions.create(
            ...
            messages=[
                ...
                "{'tipo': 'proyecto', 'accion': 'crear/eliminar', 'nombre_proyecto': 'valor', 'nombre_persona': 'valor','estado': 'valor', "
                ...
                "-los valores que puede tomar en estado de proyecto son unicamente: en curso, atraso, planificación, en pausa, hecho y cancelado.-\n"
                "-Para el caso de estado en tareas los valores que puede tomar son: sin empezar, en curso y hecho.\n"
